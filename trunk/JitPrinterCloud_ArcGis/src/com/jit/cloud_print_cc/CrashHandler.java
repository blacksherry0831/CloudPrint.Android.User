...
public class CrashHandler implements UncaughtExceptionHandler {  
   ...
   /** 错误报告文件的扩展名 */  
   private static final String CRASH_REPORTER_EXTENSION = ".cr.txt";  
   ...
   private String saveCrashInfoToFile(Throwable ex) {  
       ...
       try {  
           ...
           // 保存文件
           File f=new File(LibCui.GetCloudPrintCfgFile(),fileName);
           //FileOutputStream trace = mContext.openFileOutput(fileName, Context.MODE_PRIVATE);  
           FileOutputStream trace =new  FileOutputStream(f,true);
           if(result!=null&&trace!=null){
        	   trace.write("Cui".getBytes("UTF-8"));
        	   trace.write("\r\n".getBytes("UTF-8"));
               trace.write(result.getBytes("UTF-8"));
               trace.write("\r\n".getBytes("UTF-8"));
           }
       ...
       try {  
           long timestamp = System.currentTimeMillis();  
           String fileName = "crash-" + String.valueOf(timestamp) + CRASH_REPORTER_EXTENSION;  
           // 保存文件
