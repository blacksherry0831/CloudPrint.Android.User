...
public class PayDemoActivity extends FragmentActivity {
	...
	public static String getOrderInfo(String subject, String body, String price) {
		...
		// 服务器异步通知页面路径
		orderInfo += "&notify_url=" + "\"" + "http://www.qindayin.com" + "\"";
	 ...
	 * 
	 */
	public static String getOrderInfoQin(String subject, String body, String price,String ProductId) {
		...
		// 商户网站唯一订单号
		try {
			orderInfo += "&out_trade_no=" + "\"" +  URLEncoder.encode(ProductId,"UTF-8") + "\"";
		...
		// 商品名称
		try {
			orderInfo += "&subject=" + "\"" +  URLEncoder.encode(subject,"utf-8")  + "\"";
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		// 商品详情
		try {
			orderInfo += "&body=" + "\"" + URLEncoder.encode(body,"utf-8") + "\"";
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
